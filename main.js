...
body = `<a href="tel:${get_lest_meesege_let[1]}"><img src="https://github.com/zevisvei/Voice_Mail_yemot/blob/main/tel.png?raw=true" width="100" height="100"></a><a href="mailto:${get_name(get_lest_meesege_let[1])[1]}?subject=ראיתי%20שהתקשרת%20אלי&body=במה%20העניין?"><img src="https://github.com/zevisvei/Voice_Mail_yemot/blob/main/gmail.png?raw=true" alt="Send Email" width="100" height="100"></a><a href="https://wa.me/+972${get_lest_meesege_let[1]}?text=ראיתי%20שהתקשרת%20אלי%20במה%20העניין?"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/220px-WhatsApp.svg.png" alt="Send watsapp" width="100" height="100"></a><a href="t.me/+972${get_lest_meesege_let[1]}"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Telegram_2019_Logo.svg/70px-Telegram_2019_Logo.svg.png" alt="Send telegram" width="100" height="100"></a>
`
